...
export interface SynthetixInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]
  ): string
  encodeFunctionData(
...
export type AccountLiquidatedEvent = TypedEvent<[string, BigNumber, BigNumber, string], AccountLiquidatedEventObject>
...
export type ExchangeTrackingEvent = TypedEvent<[string, string, BigNumber, BigNumber], ExchangeTrackingEventObject>
...
export interface Synthetix extends BaseContract {
  ...
  functions: {
    ...
    anySynthOrSNXRateIsInvalid(overrides?: CallOverrides): Promise<[boolean] & { anyRateInvalid: boolean }>
    ...
    liquidateSelf(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
  ...
  migrateEscrowContractBalance(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    migrateEscrowBalanceToRewardEscrowV2(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

    migrateEscrowContractBalance(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    liquidateSelf(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
