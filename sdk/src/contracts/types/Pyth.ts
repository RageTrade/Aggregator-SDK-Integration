...
export declare namespace PythStructs {
  ...
  export type PriceFeedStructOutput = [string, PythStructs.PriceStructOutput, PythStructs.PriceStructOutput] & {
    id: string
...
export type BatchPriceFeedUpdateEvent = TypedEvent<[number, BigNumber], BatchPriceFeedUpdateEventObject>
...
export type PriceFeedUpdateEvent = TypedEvent<[string, BigNumber, BigNumber, BigNumber], PriceFeedUpdateEventObject>
...
export interface Pyth extends BaseContract {
  ...
  functions: {
    ...
    getValidTimePeriod(overrides?: CallOverrides): Promise<[BigNumber] & { validTimePeriod: BigNumber }>
