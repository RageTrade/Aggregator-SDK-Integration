...
export declare namespace PerpsV2MarketData {
  ...
  export type FeeRatesStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
    takerFee: BigNumber
    makerFee: BigNumber
  ...
  export type MarketSizeDetailsStructOutput = [BigNumber, PerpsV2MarketData.SidesStructOutput, BigNumber, BigNumber] & {
    marketSize: BigNumber
