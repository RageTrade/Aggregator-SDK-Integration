...
export interface SystemStatusInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>, PromiseOrValue<boolean>, PromiseOrValue<boolean>]
  ): string
  encodeFunctionData(
...
export type AccessControlUpdatedEvent = TypedEvent<[string, string, boolean, boolean], AccessControlUpdatedEventObject>
...
export type FuturesMarketResumedEvent = TypedEvent<[string, BigNumber], FuturesMarketResumedEventObject>
...
export type FuturesMarketSuspendedEvent = TypedEvent<[string, BigNumber], FuturesMarketSuspendedEventObject>
...
export type SynthExchangeResumedEvent = TypedEvent<[string, BigNumber], SynthExchangeResumedEventObject>
...
export type SynthExchangeSuspendedEvent = TypedEvent<[string, BigNumber], SynthExchangeSuspendedEventObject>
...
export interface SystemStatus extends BaseContract {
  ...
  functions: {
    ...
    resumeExchange(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>

    resumeFutures(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
    ...
    resumeIssuance(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
  ...
  systemSuspension(overrides?: CallOverrides): Promise<[boolean, BigNumber] & { suspended: boolean; reason: BigNumber }>
  ...
  populateTransaction: {
    ...
    resumeExchange(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>

    resumeFutures(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
    ...
    resumeIssuance(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
