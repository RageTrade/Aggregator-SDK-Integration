...
export type PerpsTrackingEvent = TypedEvent<[string, string, string, BigNumber, BigNumber], PerpsTrackingEventObject>
...
export type PositionFlaggedEvent = TypedEvent<[BigNumber, string, string, BigNumber], PositionFlaggedEventObject>
