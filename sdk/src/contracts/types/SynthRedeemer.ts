...
export type SynthDeprecatedEvent = TypedEvent<[string, BigNumber, BigNumber, BigNumber], SynthDeprecatedEventObject>
...
export type SynthRedeemedEvent = TypedEvent<[string, string, BigNumber, BigNumber], SynthRedeemedEventObject>
