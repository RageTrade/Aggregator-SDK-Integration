...
export const getPerpsV2MarketMulticall = (marketAddress: string) => new EthCallContract(marketAddress, PerpsV2MarketABI)

export const getContractsByNetwork = (networkId: NetworkId, provider: ethers.providers.Provider) => {
  return {
    ...
    PerpsV2MarketSettings: ADDRESSES.PerpsV2MarketSettings[networkId]
      ...
      : undefined,
    Pyth: ADDRESSES.Pyth[networkId] ? Pyth__factory.connect(ADDRESSES.Pyth[networkId], provider) : undefined,
    ...
    SynthSwap: ADDRESSES.SynthSwap[networkId]
      ...
      : undefined,
    SUSD: ADDRESSES.SUSD[networkId] ? ERC20__factory.connect(ADDRESSES.SUSD[networkId], provider) : undefined,
