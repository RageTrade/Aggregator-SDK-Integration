...
export const getCrossMarginAccounts = async function <K extends keyof CrossMarginAccountResult>(
  ...
  const paginatedOptions: Partial<MultiQueryOptions<CrossMarginAccountFilter, CrossMarginAccountResult>> = {
    ...options
  }
...
export const getCrossMarginAccountTransferById = async function <K extends keyof CrossMarginAccountTransferResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getCrossMarginAccountTransfers = async function <K extends keyof CrossMarginAccountTransferResult>(
  url: string,
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginatedOptions.orderDirection = options.orderDirection || 'asc'
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof CrossMarginAccountTransferFilter
    paginatedOptions.where = { ...options.where }
  }
...
export const getFuturesAggregateStatById = async function <K extends keyof FuturesAggregateStatResult>(
  url: string,
  options: SingleQueryOptions,
  ...
  if (obj['feesCrossMarginAccounts']) formattedObj['feesCrossMarginAccounts'] = wei(obj['feesCrossMarginAccounts'], 0)
...
export const getFuturesAggregateStats = async function <K extends keyof FuturesAggregateStatResult>(
  ...
  const paginatedOptions: Partial<MultiQueryOptions<FuturesAggregateStatFilter, FuturesAggregateStatResult>> = {
    ...options
  }
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginatedOptions.orderDirection = options.orderDirection || 'asc'
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof FuturesAggregateStatFilter
    paginatedOptions.where = { ...options.where }
  }
...
export const getFuturesCumulativeStatById = async function <K extends keyof FuturesCumulativeStatResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getFuturesCumulativeStats = async function <K extends keyof FuturesCumulativeStatResult>(
  url: string,
  options: MultiQueryOptions<FuturesCumulativeStatFilter, FuturesCumulativeStatResult>,
  args: FuturesCumulativeStatArgs<K>
): Promise<Pick<FuturesCumulativeStatResult, K>[]> {
  const paginatedOptions: Partial<MultiQueryOptions<FuturesCumulativeStatFilter, FuturesCumulativeStatResult>> = {
    ...options
  }
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginatedOptions.orderDirection = options.orderDirection || 'asc'
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof FuturesCumulativeStatFilter
    paginatedOptions.where = { ...options.where }
  }
...
export const getFuturesMarginAccountById = async function <K extends keyof FuturesMarginAccountResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getFuturesMarginAccounts = async function <K extends keyof FuturesMarginAccountResult>(
  ...
  const paginatedOptions: Partial<MultiQueryOptions<FuturesMarginAccountFilter, FuturesMarginAccountResult>> = {
    ...options
  }
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginatedOptions.orderDirection = options.orderDirection || 'asc'
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof FuturesMarginAccountFilter
    paginatedOptions.where = { ...options.where }
  }
...
export const getFuturesMarginTransferById = async function <K extends keyof FuturesMarginTransferResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getFuturesMarginTransfers = async function <K extends keyof FuturesMarginTransferResult>(
  url: string,
  options: MultiQueryOptions<FuturesMarginTransferFilter, FuturesMarginTransferResult>,
  args: FuturesMarginTransferArgs<K>
): Promise<Pick<FuturesMarginTransferResult, K>[]> {
  const paginatedOptions: Partial<MultiQueryOptions<FuturesMarginTransferFilter, FuturesMarginTransferResult>> = {
    ...options
  }
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginatedOptions.orderDirection = options.orderDirection || 'asc'
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof FuturesMarginTransferFilter
    paginatedOptions.where = { ...options.where }
  }
...
export const getSmartMarginAccounts = async function <K extends keyof SmartMarginAccountResult>(
  ...
  const paginatedOptions: Partial<MultiQueryOptions<SmartMarginAccountFilter, SmartMarginAccountResult>> = {
    ...options
  }
