...
export const formatTxTimestamp = (timestamp: number | Date) => formatDate(timestamp, 'MMM d, yy | HH:mm')
...
export const formatShortDateWithTime = (date: Date | number) => formatDate(date, 'MMM d, yyyy h:mm a')
...
export const calculatedTimeDifference = (dateLeft: Date, dateRight: Date) => differenceInSeconds(dateLeft, dateRight)
